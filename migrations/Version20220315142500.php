 ...
 */
final class Version20220315142500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE second_carousel (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, texte VARCHAR(255) DEFAULT NULL, image_name VARCHAR(100) NOT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE second_carousel');
